<div>
    ...
    <div class="section-title-01 honmob">
        <div class="bg_parallax newimage_02_parallax"></div>
                                ...
                                <form class="form-horizontal" wire:submit.prevent="createService">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            @else
                                                <img src="{{ asset('newimages/services/thumbnails') }}/{{ $thumbnail }}" width="60" />
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="newimage" class="control-label col-sm-3">newimage: </label>
                                        <div class="col-sm-9">
                                    ...
                                    {{-- <div class="form-group">
                                        <label for="name" class="control-label col-sm-3">newimage: </label>
                                        <div class="col-sm-9">
                                            <input type="file" class="form-control-file" name="newimage" wire:model="newimage"/>
                                            @error('newimage')
                                                <p class="text-danger">{{ $message }}</p>
