    ...
    <section class="tp-banner-container">
            <div class="tp-banner">
                <ul>
                    <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000"
                        ...
                        <img src="images/carpenter-cutting-mdf-board-inside-workshop.jpg" alt="fullslide1" data-bgposition="top center"
                            data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130"
                            data-bgfitend="100" data-bgpositionend="right center">
                    </li>
                    <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="1000"
                        data-saveperformance="off" data-title="Slide">
                        <img src="images/medium-shot-people-with-wood-pieces.jpg" alt="fullslide1" data-bgposition="top center"
                            data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130"
                            data-bgfitend="100" data-bgpositionend="right center">
                    </li>
                </ul>
            ...
            <div class="filter-title">
                <div class="title-header">
                    ...
                    <p class="lead">Explore our categories of service </p>
                </div>
                <div class="filter-header">
                    <form id="sform" action="searchservices" style="color:#f3480a; method="post">
                        <input type="text" id="q" style="color:#f3480a; name="q" required="required" placeholder="What Services do you want?"
                            class="input-large typeahead" autocomplete="off" style="color:#f3480a;>
                        <input type="submit" name="submit" value="Search"  style="color:#f3480a;>
                    </form>
                </div>
            </div>
        </section>
            ...
            <div class="content_info">
                <div>
                    <div class="container">
                        <div class="row">
                            <div class="titles">
                                <h2>ArtiConnect <span>Choice</span> of Services</h2>
