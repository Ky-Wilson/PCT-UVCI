...
<head>
    ...
    <meta name="description" content="Articonnect est la plateforme incontournable pour découvrir et engager des artisans talentueux venant directement de Côte d'Ivoire">
    <meta name="author" content="Hl@b_Corporation">
    <meta name="viewport" content="width=device-{{ asset('') }}width, initial-scale=1.0">
    ...
    <div id="layout">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+2250103793101"><i class="fa fa-phone"></i> +225 0103793101</a></li>
                            <li><a href="mailto:yanne.kouassi@uvci.edu.ci"><i class="fa fa-envelope"></i>
                                yanne.kouassi@uvci.edu.ci</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            ...
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i> Eudoxie Yao Gnoko</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Cote d'ivoire,
                                    Abidjan</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    <li class="title">
                        <a href="#"><img src="/public/images/logopct.jpeg" style="border: 1px dotted"></a>
                    </li>
                   ...
                   {{--  <div class="col-md-3 col-xs-6 col-sm-6">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> Cote d'ivoire, Abidjan</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:yanne.kouassi@uvci.edu.ci">yanne.kouassi@uvci.edu.ci</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+2250103793101">+2250103793101</a>
                            </li>
                        </ul>
                        <h3 style="margin-top: 10px">FOLLOW US</h3>
                        <ul class="social">
                            <li class="facebook"><span><i class="fa fa-facebook"></i></span><a href="https://www.facebook.com/profile.php?id=61562747318682">Facebook</a></li>
                            <li class="whatsapp"><span><i class="fa fa-whatsapp"></i></span><a href="https://whatsapp.com/channel/0029VakE9kW0QeaqyNdde02w">Whatsapp Community</a></li>
                            <li class="github"><span><i class="fa fa-instagram"></i></span><a href="https://github.com/Ky-Wilson">Github</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="social mlist-h">
                            <li class="facebook"><span><i class="fa fa-facebook"></i></span><a href="https://www.facebook.com/profile.php?id=61562747318682">Facebook</a></li>
                            <li class="whatsapp"><span><i class="fa fa-whatsapp"></i></span><a href="https://whatsapp.com/channel/0029VakE9kW0QeaqyNdde02w">Whatsapp Community</a></li>
                            <li class="tiktok"><span><i class="fa fa-tiktok"></i></span><a href="https://www.tiktok.com/@articonnect55?is_from_webapp=1&sender_device=pc">Tiktok</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2024 ArtiConnect. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
