    ...
    public function updateService(){
                $this->validate([
                    ...
                    if($this->newimage){
                        ...
                        $this->newimageimage->storeAs('services', $imageName2);
                        $service -> image = $imageName2;
                    }


                    $service-> save();
                    session()->flash('message', 'Service has been ed successfully !');
    }

    public function render()
    {
        $categories = ServiceCategory::all();
        return view('livewire.admin.admin-edit-service-component',['categories=>'])->layout('layouts.base');
    }
}
